    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                ...
                <div x-data="{ editPeriod: false, period: @js($manfeeDoc->period) }" class="mt-2">
                    ...
                    <template x-if="editPeriod">
                        <form method="POST" action="{{ route('management-fee.periodUpdate', $manfeeDoc->id) }}"
                ...
                <div x-data="{ editSubject: false, subject: @js($manfeeDoc->letter_subject) }" class="mt-2">
                    ...
                    <template x-if="editSubject">
                        <form method="POST" action="{{ route('management-fee.perihalUpdate', $manfeeDoc->id) }}"
                            class="flex items-center gap-2 mt-2">
                            @csrf
                            @method('PUT')
                ...
                <div x-data="{ editRef: false, ref: @js($manfeeDoc->reference_document) }" class="mt-2">
                    ...
                    <template x-if="editRef">
                        <form method="POST" action="{{ route('management-fee.referenceUpdate', $manfeeDoc->id) }}"
                            class="flex items-center gap-2 mt-2">
                            @csrf
                            @method('PUT')
