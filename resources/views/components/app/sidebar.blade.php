        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 
                    bg-[linear-gradient(135deg,var(--tw-gradient-stops))] 
                    @if (Request::is('user*') || Request::routeIs('contracts*') || Request::routeIs('contract-categories*') || Request::is('register*')) from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04] @endif"
                        ...
                        @if (!Request::is('user*') && !Request::routeIs('contracts*') && !Request::is('register*')) hover:text-gray-900 dark:hover:text-white @endif"
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current 
                                    @if (Request::is('user*') || Request::is('contracts*') || Request::is('contract-categories*') || Request::is('register*')) text-violet-500 
                                    @else 
                                        text-gray-400 dark:text-gray-500 @endif"
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 16 16">
