...
<div class="mt-5 mb-5 md:mt-0 md:col-span-2">
    <div class="flex justify-between items-center mb-3">
        ...
        <div class="flex gap-2 mt-4 sm:mt-0">
            <x-modal.non-management-fee.detail-biaya.modal-create-detailbiaya :nonManfeeDocument="$nonManfeeDocument" :jenis_biaya="$jenis_biaya"
                :account_detailbiaya="$account_detailbiaya" />
            {{-- @if ($nonManfeeDocument->detailPayments && $nonManfeeDocument->detailPayments->isNotEmpty())
                <x-modal.management-fee.detail-biaya.modal-edit-detailbiaya :nonManfeeDocument="$nonManfeeDocument" :jenis_biaya="$jenis_biaya"
                    :account_detailbiaya="$account_detailbiaya" />
            @endif --}}
        </div>
