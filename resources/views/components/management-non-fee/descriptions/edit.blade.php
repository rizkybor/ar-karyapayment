<div class="mt-5 mb-5 md:mt-0 md:col-span-2">
    <div class="flex justify-between items-center mb-3">
        ...
        <x-modal.management-non-fee.modal-create-description :nonManfeeDocument="$nonManfeeDocument" />
    </div>
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center flex items-center justify-end gap-2">
                                            ...
                                            <form id="delete-description-{{ $desc->id }}" method="POST"
                                                action="{{ route('management-non-fee.descriptions.destroy', ['id' => $nonManfeeDocument->id, 'description_id' => $desc->id]) }}"
                                                class="hidden">
                                                @csrf
                                                @method('DELETE')
                                            </form>
