        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-5xl w-full"
            ...
            <div class="mb-4">
                ...
                <select id="expense_type" name="expense_type"
                    ...
                    x-model="selectedExpenseType" @change="changeSelectedExpenseType($event.target.value)">
    ...
    document.addEventListener("alpine:init", () => {
        Alpine.data("expenseFilter", () => ({
            ...
            filterTable() {
                ...
                rows.forEach(row => {
                    const expenseType = row.querySelector('td:nth-child(4)').textContent
                        .trim();
                    if (this.selectedExpenseType === '' || expenseType === this
                        .selectedExpenseType) {
                        row.style.display = '';
                    } else {
