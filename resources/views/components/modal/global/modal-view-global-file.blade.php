...
@php
    $filePath = str_replace('?dl=0', '?raw=1', $file->path);
        ...
        <div class="mt-4 flex flex-col items-center justify-center w-full">
            ...
            @else
                ...
                <p class="text-sm text-gray-500 text-center">
                    <a href="{{ $filePath }}" target="_blank" class="text-blue-500 underline">
                        Klik di sini untuk melihat {{ $file->file_name }}.pdf
                    </a>
                </p>
            @endif
        </div>
