<div id="amandemenDocumentModal"
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-md w-full mx-4 sm:mx-0">
        ...
        <form id="amandemenDocumentForm" method="POST" enctype="multipart/form-data">
            ...
            {{-- Alasan --}}
            <div class="mb-4" id="amandemenReasonGroup">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Alasan Amandemen
                    :</label>
                {{-- Input saat submit --}}
                <input type="text" name="reason" id="amandemenReasonInput" required
                    class="form-input w-full rounded-md">

                {{-- Teks saat view only --}}
                <p id="amandemenReasonText" class="hidden justify text-red-800 dark:text-gray-100 text-sm"></p>
            </div>
            ...
            <div class="mt-4 mb-4 hidden flex flex-col items-center justify-center gap-2" id="amandemenFilePreview">
...
<script>
    function openAmandemenModal(actionUrl = '', isViewOnly = false, reason = '', fileUrl = '') {
        const form = document.getElementById('amandemenDocumentForm');
        const modal = document.getElementById('amandemenDocumentModal');
        const title = document.getElementById('amandemenModalTitle');

        const reasonGroup = document.getElementById('amandemenReasonGroup');
        const reasonInput = document.getElementById('amandemenReasonInput');
        const reasonText = document.getElementById('amandemenReasonText');

        const fileInput = document.getElementById('amandemenFileInput');
        const fileSection = document.getElementById('fileUploadSection');
        const filePreview = document.getElementById('amandemenFilePreview');
        const fileLink = document.getElementById('amandemenFileLink');
        const submitButton = document.getElementById('amandemenSubmitButton');
