@props(['nonManfeeDocument', 'detailPaymentId', 'jenis_biaya', 'account_detailbiaya'])
...
<div x-data="{
    ...
    <div class="fixed inset-0 bg-gray-900 bg-opacity-30 z-50 flex items-center justify-center" x-show="modalOpen" x-cloak>
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-md w-full"
            ...
            <form method="POST"
                action="{{ route('non-management-fee.detail_payments.update', ['id' => $nonManfeeDocument->id, 'detail_payment_id' => $detailPaymentId->id]) }}">
                @csrf
                @method('PUT')
