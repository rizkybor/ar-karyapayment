...
class ManfeeHistoryController extends Controller
{
  /**
  ...
  {
    $histories = ManfeeDocHistories::latest()->get();
  ...
  public function show($id)
  {
    try {
      ...
      $document = ManfeeDocument::with('histories.performedBy')->find($id);
  ...
  public function store(Request $request)
  {
    ...
    $history = ManfeeDocHistories::create($request->all());
  ...
  {
    $history = ManfeeDocHistories::findOrFail($history_id);
    $history->delete();
