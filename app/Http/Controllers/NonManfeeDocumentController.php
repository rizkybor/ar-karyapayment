        ...
        try {
            ...
            if ($document->last_reviewers === 'pajak') {
                ...
                try {
                    ...
                    $createInvoice = $this->sendToPrivy($base64inv, '0', '535.61', '690.45', $refInvoice, $noInv, $jenis_dokumen);
                    ...
                    $createKwitansi = $this->sendToPrivy($base64kw, '2', '530.81', '767.33', $refKwitansi, $noKw, $jenis_dokumen);
